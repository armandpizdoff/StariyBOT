...
def rasskaziki(call):
    if call.data == 'stories':
        ...
        button4 = telebot.types.InlineKeyboardButton(text='Назад к аудиокнигам', callback_data='stories')
        ...
        markup.add(telebot.types.InlineKeyboardButton(text='Назад к аудиокнигам', callback_data='stories'))
        bot.send_chat_action(call.message.chat.id, 'upload_audio')
        bot.send_audio(call.message.chat.id, audio=open(STORIES + 'ordersong1.ogg', 'rb'))
        time.sleep(1)
        bot.send_audio(call.message.chat.id, audio=open(STORIES + 'ordersong2.ogg', 'rb'))
        time.sleep(1)
        bot.send_audio(call.message.chat.id, audio=open(STORIES + 'ordersong3.ogg', 'rb'))
        time.sleep(1)
