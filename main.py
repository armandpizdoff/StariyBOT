...
def query_handler(call):
    ...
    #    bot.send_message(call.message.chat.id, worksheet.cell_value(i, j))
        ...
        bot.send_message(call.message.chat.id, text='<b>Команды навигации и манипуляторы: </b>'
                                                    ...
                                                    '\n7) <b>cp user/file.txt ./file_super</b> - '
                                                    '. - копирует в текущую директорию. После слэша - новое '
                                                    'название для копии (если оно требуется). '
                                                    '\n8) <b>cp -r /home/user/directory/</b> - рекурсивное копирование'
                                                    'непустого каталога. '
        ...
        bot.send_message(call.message.chat.id, text='<b>Полезные примечания: </b>'
                                                    ...
                                                    '\n5) <b>history</b> - выведет полную историю вводов команд от '
                                                    'пользователя'
                                                    '\n6) <b>uname</b> - показать ОС. <b>uname -a</b> - точная '
                                                    'информация про ОС, версия ядра и т.п.'
                                                    ...
                                                    '\n10) <b>top</b> - сводка потребления памяти и CPU. Kind of '
                                                    'диспетчер задач '
                                                    '\n11) <b>ifconfig</b> - покажет сетевые интерфейсы на сервере. '
                                                    '\n12) <b>nmap example.com</b> - прога покажет открытые порты '
        ...
        bot.send_message(call.message.chat.id, text='<b>VIM:</b> '
                                                    ...
                                                    '\n<b>a</b> - перейти в режим ввода. Внизу должна появиться '
                                                    'надпись INSERT. '
                                                    '\n<b>ESC</b> - перейти в режим просмотра. '
                                                    '\n<b>:w</b> - записать изменения. Если документ новый - после '
                                                    '"w" написать будущее название файла. '
